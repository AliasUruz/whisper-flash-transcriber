        ...
        with operation_context(
            ...
            if is_agent_mode:
                ...
                try:
                    ...
                    result = agent_response or transcribed_text
                    metrics["ai_status"] = "success" if agent_response else "fallback"
                    metrics["ai_result_chars"] = len(result or "")
                    return result
                except TimeoutError:
            ...
            if correction_succeeded and processed_text != transcribed_text:
                branch = "corrected"
            metrics["ai_branch"] = branch
