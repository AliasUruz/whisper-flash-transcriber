...
def on_settings_menu_click(*_):
    """Abre a janela de configurações de forma segura."""
    global settings_window_instance, core_instance, main_tk_root

    if settings_window_instance and settings_window_instance.winfo_exists():
        settings_window_instance.focus_force()
        return

    if SettingsWindow and core_instance and main_tk_root:
        settings_window_instance = SettingsWindow(main_tk_root, core_instance)
    else:
        pass
