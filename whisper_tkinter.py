...
def run_settings_gui():
    """Abre a janela de configurações da nova interface."""
    global settings_window_instance, settings_thread_running, main_tk_root
...
if __name__ == "__main__":
    ...
    # 1. CRIAR A JANELA PRINCIPAL USANDO CUSTOMTKINTER
    # A classe ``MainWindow`` é responsável pela interface principal
    ...
    # Instanciar a janela principal agora que o núcleo está pronto
    main_tk_root = MainWindow(core_instance)
